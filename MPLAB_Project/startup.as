	...
	; Compiler options:
	;
	; -oYF.cof -mYF.map --summary=default --output=default YellowFlash.p1 \
	; --chip=18F45K80 -P --runtime=default --opt=default -D__DEBUG=1 -g \
